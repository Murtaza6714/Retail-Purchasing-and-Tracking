  ...
  $a=0;
    ...
    if (!$con){
      die("connection to  this database failed due to".mysqli_connect_error());
        ...
        $sql = "select * from costumerrequest";
...
<h1 style="text-align: center; margin-top: 50px; margin-bottom: 50px; text-shadow: 4px 4px 7px lightblue ; font-family: 'Lemonada', cursive;">Retail Purchasing and Tracking</h1>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link passive" href="CostumerRequest.php">COSTUMER REQ <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item active">
                <a class="nav-link" href="#">VIEW PRODUCT <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item active">
                <a class="nav-link" href="logout2.php">LOGOUT<span class="sr-only">(current)</span></a>
              </li>
              </ul>
        </div>
      </nav>
  ...
  if(isset($_POST['submit'])){
    ...
    $sql1="INSERT INTO `reply` (`ProductCategory`, `ProductName`, `BrandName`, `Pricing`) VALUES ('$productcategory', '$productname', '$brandname', '$pricing')";
  ...
  if($result->num_rows > 0){
    while($rows = $result->fetch_assoc()){
        ...
        <td><form method="POST">
          ...
          <input type="text" placeholder="price" name="pricing" required>
