  ...
  $flag=0;
    ...
    if (!$con){
      die("connection to  this database failed due to".mysqli_connect_error());
        ...
        $sql = "select ProductCategory,ProductName,BrandName from addproduct where ProductCategory = 'Electronics'";
        ...
        $result = $con->query($sql);
            ...
            ?>
    <section>
        <h1 style="text-align: center; margin-top: 50px; text-shadow: 4px 4px 7px lightblue ; margin-bottom: 50px; font-family: 'Lemonada', cursive;">Retail
        ...
        ?><tr><th scope="row"><?=$a=$a+1?></th>
          ...
          <td> 
            <form method="POST"> 
              ...
              <input type="submit" style="margin-left: 10px;" class="btn btn-primary" name="submit">
            </form>
          <?php
          if($flag==1){
            ?><div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Successfully Added your quantity</strong>
